...
\section{Secure Code - Crash course}
  ...
  \subsection{Requirements, User Stories and Tasks}
    ...
    \begin{block}{It's hard to patch security in}
      When security countermeasures are added as a reaction, there is a risk that the patch itself introduces new threats.
  ...
  \subsection{Security code review}
    \begin{frame}
    \frametitle{Security code review}
    \begin{itemize}
    \item
    \end{itemize}
    \end{frame}
